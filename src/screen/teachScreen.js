...
const TeachScreen = () => {
    return (
        <ScrollView style={{ backgroundColor: "white" }}>
            <Text style={{ color: "black" }}>【首頁】</Text>
            <View style={{ marginHorizontal: 20 }}>
                <Text style={{ color: "black" }}>1.經期設定：個人化設定經期與週期長度</Text>
                ...
                <View style={styles.Direction_row}>
                    ...
                    <View style={styles.marginTop_10}>
                        <Text style={{ color: "black" }}>經期長度：</Text>
                        <Text style={[styles.directions_text, { color: "black" }]}>更改經期開始至結束的時間長度，改變預設標記時長。</Text>
                    </View>
                </View>
                ...
                <View style={styles.Direction_row}>
                    ...
                    <View style={styles.marginTop_10}>
                        <Text style={{ color: "black" }}>週期長度：</Text>
                        <Text style={[styles.directions_text, { color: "black" }]}>更改上次經期結束到下次開始的時間，改變每次經期的間隔時長。</Text>
                    </View>
                </View>
                ...
                <View style={styles.Direction_row}>
                    ...
                    <View style={styles.marginTop_10}>
                        <Text style={{ color: "black" }}>自動推算：</Text>
                        <Text style={[styles.directions_text, { color: "black" }]}>經期第一天開始時，自動往後計算、標記到經期結束。</Text>
                    </View>
                </View>
            </View>

            <View style={{ marginHorizontal: 20 }}>
                <Text style={[styles.articletext, { color: "black" }]}>2.通知設定</Text>
                ...
                <View style={styles.Direction_row}>
                    ...
                    <View style={styles.marginTop_10}>
                        <Text style={{ color: "black" }}>經期開始/結束通知：</Text>
                        <Text style={[styles.directions_text, { color: "black" }]}>於預估經期開始時間的前3天開始通知。</Text>
                    </View>
                </View>
                ...
                <View style={styles.Direction_row}>
                    ...
                    <View style={styles.marginTop_10}>
                        <Text style={{ color: "black" }}>身體狀態通知：</Text>
                        <Text style={[styles.directions_text, { color: "black" }]}>推算目前使用者的身體狀態(黃體期、易孕期...)，並進行通知。</Text>
                    </View>
                </View>
            </View>
        </ScrollView>
